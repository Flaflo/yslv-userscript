...
import type { SkeletonNorm } from "../types/style"

let _cached: SkeletonNorm | null = null
...
export function skNorm(cfg: Cfg): SkeletonNorm {
  ...
  _cached = { enabled: s.enabled, lines, gap, h, w, r, maxW, ms }
  return _cached
}

export function invalidateSkNormCache(): void {
  _cached = null
}
